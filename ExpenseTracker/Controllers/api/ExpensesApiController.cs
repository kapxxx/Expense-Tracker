...
namespace ExpenseTracker.Controllers.api
{
    ...
    public class ExpensesApiController : ControllerBase
    {
        ...
        public ExpensesApiController(AppDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Expense>> PostExpense(Expense expense)
        {
            ...
            return CreatedAtAction("GetExpense", new { id = expense.E_Id }, expense);
        }
        ...
        {
            return _context.Expenses.Any(e => e.E_Id == id);
        }
    }
}
